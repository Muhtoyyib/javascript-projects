...
let myAgeDif = myAge - yourAge;
let yourAgeDif = yourAge - myAge;

if((myAge > yourAge)){
    console.log(`I are ${myAgeDif} years older than you.`);
} else {
    console.log(`You are ${yourAgeDif} years older than me.`);
}
